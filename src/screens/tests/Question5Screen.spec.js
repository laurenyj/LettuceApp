...
describe('Question5Screen', () => {
  ...
  it('renders the screen correctly', async() => {
    ...
    expect(screen.findByText(question5.question)).toBeDefined();
    expect(screen.findByText(question5.options[0].text)).toBeDefined();
    expect(screen.findByText(question5.options[1].text)).toBeDefined();
    expect(screen.findByText(question5.options[2].text)).toBeDefined();
    expect(screen.findByText(question5.options[3].text)).toBeDefined();
  });
