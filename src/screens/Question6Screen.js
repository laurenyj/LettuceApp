...
const Question6Screen = ({ navigation }) => {
  ...
  const handleAnswer = (answer) => {
    updateQuestionFormState({ [question6.id]: answer })
  };
    ...
    <SafeAreaView style={styles.container}>
      <ImageBackground source={require('../../assets/pattern.jpg')} style={styles.appContainer}>
        ...
        <QuestionCard
          ...
          onSubmit={() => navigation.navigate('Results')}
          options={question6.options}
          questionText={question6.question}
          selectedOption={questionFormState[question6.id]}
        />
      </ImageBackground>
    </SafeAreaView>
